...
describe('stringEnumGenerator tests', () => {
  ...
  it('Returns the expected value for a simple ValueSet.', () => {
    ...
    const expectedValue = readFileSync(join(__dirname, '__fixtures__', 'simpleValueSetEnum.ts'), 'utf-8').replace(
      /\s/g,
      '',
    );
  ...
  it('Returns the expected value for a ValueSet in which one of the codes has been deprecated.', () => {
    ...
    const expectedValue = readFileSync(join(__dirname, '__fixtures__', 'deprecatedValueSetEnum.ts'), 'utf-8').replace(
      /\s/g,
      '',
    );
  ...
  it('Returns the expected value for a ValueSet in which one of the codes has been marked as abstract.', () => {
    ...
    const expectedValue = readFileSync(join(__dirname, '__fixtures__', 'abstractValueSetEnum.ts'), 'utf-8').replace(
      /\s/g,
      '',
    );
  ...
  it('Returns the expected value for a ValueSet in which there is not description/display.', () => {
    ...
    const expectedValue = readFileSync(
  ...
  it('Includes the "export" keyword when instructed to do so.', () => {
    ...
    const expectedValue = readFileSync(join(__dirname, '__fixtures__', 'exportedValueSetEnum.ts'), 'utf-8').replace(
      /\s/g,
      '',
    );
  ...
  it('Produces both a "code" and a "Coding" enum.', () => {
    ...
    const expectedValue = readFileSync(join(__dirname, '__fixtures__', 'codingOnlyValueSetEnum.ts'), 'utf-8').replace(
      /\s/g,
      '',
    );
  ...
  it('Produces both a "code" and a "Coding" enum.', () => {
    ...
    const expectedValue = readFileSync(join(__dirname, '__fixtures__', 'bothValueSetEnum.ts'), 'utf-8').replace(
      /\s/g,
      '',
    );
