...
export type ValueSet = ValueSetR2 | ValueSetR3 | ValueSetR4 | ValueSetR4B | ValueSetR5;
...
export type Bundle<T = ValueSet> = BundleR2<T> | BundleR3<T> | BundleR4<T> | BundleR4B<T> | BundleR5<T>;
